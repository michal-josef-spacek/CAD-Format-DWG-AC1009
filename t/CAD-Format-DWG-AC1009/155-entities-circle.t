...
is($circle1_data->center_point_x, 1, 'Center point of cicrle x (1).');
is($circle1_data->center_point_y, 1, 'Center point of circle y (1).');
...
is($entity_common->entity_layer_index, 0, 'circle layer index (0).');
is($entity_common->entity_size, 50, 'Entity size (50).');
is($entity_common->entity_elevation, 10, 'Entity elevation (10).');
is($entity_common->entity_thickness, 2, 'Entity thickness (2).');
is($circle1_data->center_point_x, 1, 'Center point of cicrle x (1).');
is($circle1_data->center_point_y, 1, 'Center point of circle y (1).');
is($circle1_data->radius, 3, 'Radius of circle (3).');
